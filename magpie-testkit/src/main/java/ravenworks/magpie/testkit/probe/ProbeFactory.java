package ravenworks.magpie.testkit.probe;
...
public final class ProbeFactory {
    ...
    public static final String EVENT_TYPE = "testkit.probe";
    public static final String EXT_BUSINESS_KEY = "xbusinesskey";

    private static final URI EVENT_SOURCE = URI.create("magpie-testkit");
