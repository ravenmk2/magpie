...
(
    ...
    `type`         VARCHAR(256) NOT NULL DEFAULT '' COMMENT '消息类型',
    `event_time`   DATETIME(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '发生时间',
    `topic`        VARCHAR(256) NOT NULL DEFAULT '' COMMENT '消息主题',
    `tenant_id`    VARCHAR(256) NOT NULL DEFAULT '' COMMENT '租户 ID',
    `business_key` VARCHAR(256) NOT NULL DEFAULT '' COMMENT '业务键',
