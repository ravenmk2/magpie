...
class RoundRobinAddressResolverTest {
    ...
    @Test
    void emptyUriListRejected() {
        // 空地址列表会让 resolve() 取模抛 ArithmeticException，构造期直接拒绝
        assertThrows(IllegalArgumentException.class, () -> new RoundRobinAddressResolver(List.of()));
    }
