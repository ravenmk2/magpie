...
@Data
@ConfigurationProperties("soak.loadgen")
public class LoadgenProperties {
     ...
     */
    private String source = "soak-http";

    /**
     * 负载覆盖的 topic 列表，每 topic 独立 keyspace
     */
    private List<String> topics = new ArrayList<>(List.of("soak-ordered", "soak-key-ordered", "soak-best-effort"));
    ...
    public static class Outbox {
        ...
        private String topic = "soak-outbox";
